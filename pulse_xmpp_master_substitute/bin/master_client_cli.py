...
def get_cli_parameter():
    ...
    parser.add_argument('--message_type', choices=['iq', 'message', 'test'], default='message')
    parser.add_argument('--address_format', choices=['ipv6', 'ipv4'], default='ipv4')
    parser.add_argument('--test', type=bool, default=False)
    parser.add_argument('--message_structure', choices=['json', 'yaml', 'xml'], default='json')
    parser.add_argument('--debug_level', choices=['NOTSET', 'INFO', 'DEBUG'], default='NOTSET')
    parser.add_argument('--config_file', default='/etc/pulse-xmpp-agent-substitute/__server_mmc_master.ini')
