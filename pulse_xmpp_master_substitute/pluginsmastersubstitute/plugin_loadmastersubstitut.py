...
from pulse_xmpp_master_substitute.lib.utils import getRandomName, call_plugin, call_plugin_separate, simplecommand
...
plugin = {"VERSION": "1.0", "NAME": "loadmastersubstitut", "TYPE": "substitute"}  # fmt: skip
