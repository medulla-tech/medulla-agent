...
def scheduledeployrecoveryjob(self):
    ...
    try:
        ...
        machines_waitting_online = XmppMasterDatabase(
        ...
        for machine in machines_waitting_online:
            ...
            if XmppMasterDatabase().getPresenceuuid(machine['inventoryuuid']):
                ...
                # il faut verifier qu'il y ai 1 groupe deja en syncthing.alors
                # seulement on peut decoder de l'incorporer
    ...
    try:
        ...
        if 'error' in objmachine and objmachine['error'] == "MultipleResultsFound":
            logger.warn(
                ...
                objmachine['error'])
            objmachine1 = XmppMasterDatabase(
