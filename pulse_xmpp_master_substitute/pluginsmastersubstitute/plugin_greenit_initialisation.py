...
# file : pluginsmastersubstitute/plugin_greenit_initialisation.py
...
plugin = {"VERSION": "1.0", "NAME": "greenit_initialisation", "TYPE": "substitute"}  # fmt: skip
...
def action(xmppobject, action, sessionid, data, msg, ret, dataobj):
    try:
        ...
        if compteurcallplugin == 0:
            read_conf_greenit_initialisation(xmppobject)
...
def main_plugin(xmppobject, action, sessionid, data, msg, ret, dataobj):
    logger.debug("====================data=========================")
    logger.debug(json.dumps(data, indent=))
    logger.debug("====================data=========================")

def read_conf_greenit_initialisation(xmppobject):
    """
...
def create_default_config(objectxmpp):
    ...
    if not os.path.isfile(pathconffile):
        ...
        Config.add_comment("Global", "This section contains global configurations")
