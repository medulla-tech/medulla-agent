...
class Glpi100(DatabaseHelper):
    """
    Singletoin Class to query the glpi database in version > 10.0 and < 10.1
    ...
    def activate(self):
        ...
        if Version(self._glpi_version) >= Version("10.0") and Version(
            self._glpi_version
        ) <= Version("10.0.20"):
        ...
        logging.getLogger().debug(
            "Trying to detect if GLPI version is higher than 10.0"
        )
