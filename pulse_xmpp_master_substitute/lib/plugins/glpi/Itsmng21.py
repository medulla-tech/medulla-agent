...
def _entity_descriptor(mapper_or_class, key):
    ...
    try:
        ...
        self.logger.debug("Itsmng activation")
        self.engine = None
        ...
        if Version(self._glpi_version) >= Version("2.1.0") and Version(self._glpi_version) <= Version("2.1.99"):
    ...
    def __getRestrictedComputersListQuery(self, ctx, filt=None, session=None, displayList=False, count=False):
        """
