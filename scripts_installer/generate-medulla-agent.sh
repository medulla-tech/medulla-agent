...
generate_agent_win() {
	...
	COMMAND="./win/generate-medulla-agent-win.sh ${GENERATION_OPTIONS} ${OPTIONS_MINIMAL}"
...
generate_agent_lin() {
	...
	COMMAND="./lin/generate-medulla-agent-linux.sh ${GENERATION_OPTIONS} ${OPTIONS_MINIMAL}"
	echo "Running "${COMMAND}
	${COMMAND}
}
