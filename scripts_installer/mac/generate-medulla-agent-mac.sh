...
# """
# This script is designed to generate Medulla XMPP agent for MacOS
...
#	In /var/lib/medulla/clients/mac/downloads/:
...
#	In /var/lib/medulla/clients/mac/downloads/python_modules/:
...
PULSE_AGENT_NAME="medulla-agent"
PULSE_AGENT_MODULE="medulla_xmpp_agent"
...
create_folder_structure() {
	...
	cp net.siveo.medulla_xmpp_agent.plist ${PKG_FOLDER_TMP}/Contents/Resources/
	# Copy launcher
	cp runmedullaagent ${PKG_FOLDER_TMP}/Contents/Resources/
	# Copy medulla filetree generator
	cp medulla-filetree-generator ${PKG_FOLDER_TMP}/Contents/Resources/
}
