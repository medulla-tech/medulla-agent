...
class grafcet:
    ...
    def action_command_natif_shell(self):
        ...
        try:
            ...
            # self.objectxmpp.logtomedulla("action_command_natif_shell")
        ...
        try:
            ...
            if sys.platform.startswith("linux"):
                ...
                command = (
                    ...
                    """C:\\progra~1\\Python3\\pythonw C:\\progra~1\\Medulla\\bin\\medulla_update_notification.py"""
    ...
    def action_question(self):
        ...
        try:
            ...
            if sys.platform.startswith("linux"):
                ...
                command = (
                    """C:\\progra~1\\medulla\\bin\\paexec.exe -accepteula -s -i 1 """
                    """C:\\progra~1\\Python3\\pythonw C:\\progra~1\\Medulla\\bin\\medulla_update_notification.py -M "%s" -B"%s" -t%s -Y "%s" -N "%s" -S%s -s%s -c"""
                    % (
                        message,
                        titlemessage,
                        self.workingstep["timeout"],
