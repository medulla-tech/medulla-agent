...
def handle_client_connection(self, msg):
    ...
    try:
        ...
        if "action" in result:
            ...
            elif result["action"] == "iqsendmedulla":
                return iqsendmedulla_str(self, result)
    ...
    actioncmd = {
        "cmd": {
            ...
            "iqsendmedulla": {
                ...
                "exemple": 'echo -n \'{"action": "iqsendmedulla", "data":  {"action": "remotexmppmonitoring", "data": "disk_usage",  "mto": "test-win-1.hpl@medulla/52540014cf93", "mtimeout": 100}}\' | nc localhost 8765',
            },
            "get_debug_level": {
                "factory command": {
...
def iqsendmedulla_str(xmppobject, result):
    ...
    try:
        ...
        del result["data"]["mto"]
        resultat = xmppobject.iqsendmedulla(tosend, result["data"], totimeout)
