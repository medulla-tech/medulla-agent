        ...
        if "subaction" in data:
            ...
            if data["subaction"] == "notify_machine_deploy_syncthing":
                ...
                if "iddeploy" in data:
                    ...
                    objectxmpp.syncthing.delete_folder_medulla_deploy(data["iddeploy"])
                ...
                if not os.path.exists(sharedFolder):
                    ...
                    if sys.platform.startswith("linux") or sys.platform.startswith(
                        ...
                        cmd = "chown -R medulla:medulla %s" % sharedFolder
                ...
                for ars in dataobjpartage["cluster"]["arslist"]:
                    if ars != '""' or ars != "":
                        if str(jid.JID(ars).domain) == "medulla":
                            name = "medulla"
                        else:
                ...
                if data["subaction"] == "syncthingdeploycluster":
                    ...
                    for keyclustersyncthing in data1["cluster"]["arslist"]:
                        ...
                        if keyclustersyncthing != '""' or keyclustersyncthing != "":
                            if str(jid.JID(keyclustersyncthing).domain) == "medulla":
                                name = "medulla"
                            else:
                    ...
                    if "iddeploy" in data:
                        ...
                        objectxmpp.syncthing.delete_folder_medulla_deploy(
                            data["iddeploy"]
                        )
                    messgagesend = {
                        "sessionid": sessionid,
