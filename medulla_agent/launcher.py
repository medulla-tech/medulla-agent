...
def directoryconffile():
    """
    This function provide the path to the configuration files of medulla-agent.
...
if __name__ == "__main__":
    ...
    if sys.platform.startswith("win"):
        ...
        logfile = os.path.join("/opt", "Medulla", "var", "log", defaultnamelogfile)
    else:
