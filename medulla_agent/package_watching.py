...
# """
# This module is dedicated to analyse inventories sent by a Medulla 2 Client.
...
logging.basicConfig(
    ...
    filename="/var/log/medulla/medulla-package-watching.log",
    filemode="a",
)
...
def conf_information(conffile):
    ...
    if Config.has_option("watchingfile", "filelist"):
        ...
        filelist = "/var/lib/medulla/packages"
    ...
    if Config.has_option("rsynctocdn", "localfolder"):
        ...
        configdata["rsynctocdn_localfolder"] = "/var/lib/medulla/packages/sharing"
...
if __name__ == "__main__":
    ...
    inifile = "/etc/medulla-agent/package_watching.ini"
