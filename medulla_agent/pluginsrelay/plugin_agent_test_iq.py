...
# MMC <...> substitutmaster(master@medulla/MASTER) ___> agent_test_iq sur ARS (rsmedulla@medulla/mainrelay) <---> to machine dev-deb12-2.zb0@medulla/525400944ac7
# le plugin present affiche le resultat de iq
# timeout
# 2023-07-10 16:40:31,902 - DEBUG - Result iq test {'error': 'IQ type get id [__rsmedulla__47wq8rbu] to [dev-deb12-2.zb0@medulla/525400944ac7] in Timeout'}
# cool
...
def action(xmppobject, action, sessionid, data, msg, dataobj):
    try:
        ...
        re = xmppobject.iqsendmedulla(
            "dev-deb12-2.zb0@medulla/525400944ac7",
            {
                "action": "test",
                "data": {
