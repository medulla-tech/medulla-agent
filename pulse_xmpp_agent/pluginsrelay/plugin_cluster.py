    ...
    for ars in objectxmpp.jidclusterlistrelayservers:
        result = {
            ...
            'data': {
                ...
                "data": {
                    "chargenumber": objectxmpp.checklevelcharge() + objectxmpp.managefifo.getcount()}},
            'ret': 0,
            'base64': False}
    ...
    if "subaction" in data:
        if data['subaction'] == "startmmc":
            ...
            jidclusterlistrelayservers = [
                jidrelayserver for jidrelayserver in data['data'] if jidrelayserver != message['to']]
            ...
            for ars in jidclusterlistrelayservers:
                if ars not in objectxmpp.jidclusterlistrelayservers:
                    objectxmpp.jidclusterlistrelayservers[ars] = {
                        'chargenumber': 0}
            ...
            objectxmpp.jidclusterlistrelayservers[message['from']
                                                  ] = data['data']
            logger.debug(
                "new ARS list friend of cluster : %s" %
                objectxmpp.jidclusterlistrelayservers)
            ...
            if 'machinejid' in data['data']:
                objectxmpp.delmachineinlevelmachinelist(
                    data['data']['machinejid'])
            else:
            ...
            if 'machinejid' in data['data']:
                objectxmpp.addmachineinlevelmachinelist(
                    data['data']['machinejid'])
            else:
